            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!-- 文件上传 -->
                        <form id="uploadForm" class="fileDown" name="uploadForm"
                              action="${pageContext.request.contextPath}/stuManagement/upload" method="post"
                        ...
                        <div class="box-tools pull-right" style="width: 200px">
                            <div class="has-feedback" style="width: 150px; vertical-align: top; display:inline-block">
                                <input id="search" type="text" style="padding-right: 0" class="form-control input-sm"
                                       placeholder="搜索">
                                <%--									<a class="glyphicon glyphicon-search form-control-feedback" type="button" style="margin-left: 10px"></a>--%>
                                <%--									<span class="glyphicon glyphicon-search form-control-feedback"></span>--%>
                            </div>
                            <div style="display: inline-block ">
                                <button id="searchbtn" onclick="search_do()" class="glyphicon glyphicon-search"
                                        type="button"
                                        style="width: 30px;height: 30px; margin-left: -3px; color: skyblue; border: 1px solid #d2d6de;"></button>
                            </div>
                        </div>
                            ...
                            <c:forEach items="${STUDENTS.list}" var="one">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="javascript:" onclick="edit1('${one.stuKey}','${one.stuName}')"
                                           class="btn bg-olive btn-xs ">修改</a>
                                        <a href="#" class="btn bg-red btn-xs"
                                           onclick="delete_do('${one.stuKey}','${one.stuName}')">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
